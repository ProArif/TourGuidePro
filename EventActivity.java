package com.arifulislam.tourguidepro.events;
...
import com.arifulislam.tourguidepro.LoginActivity;
import com.arifulislam.tourguidepro.R;
import com.arifulislam.tourguidepro.adapters.EventAdapter;
...
//        user = auth.getCurrentUser();
        ...
        eventGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(EventActivity.this,ExpenseActivity.class);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.map){
            Intent n = new Intent(EventActivity.this,MapsActivity.class);
            startActivity(n);
        }
        ...
        /*if (id == R.id.profile) {
            ...
            if (mUser != null) {
                ...
                if (currentEmail == null) {
                    Intent n = new Intent(EventActivity.this, UserProfileActivity.class);
                    startActivity(n);
                } else {
                    Toast.makeText(EventActivity.this, "Please Login to go your profile", Toast.LENGTH_LONG).show();

                }
            }
            // Handle the camera action
        } else*/ if (id == R.id.nav_weather) {
            Intent n = new Intent(EventActivity.this,WeatherActivity.class);
            startActivity(n);
            ...
            Intent n = new Intent(EventActivity.this, NearbyPlacesActivity.class);
            startActivity(n);

        }else if (id == R.id.nav_currency) {
            Intent n = new Intent(EventActivity.this, CurrencyConverterActivity.class);
            startActivity(n);
            ...
            Intent n = new Intent(EventActivity.this, EventActivity.class);
            startActivity(n);
        ...
        btn_createEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user != null) {
                    ...
                    reference.child(key).setValue(event).addOnCompleteListener(EventActivity.this, new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot items : dataSnapshot.getChildren()) {
                        ...
                        if (events.size() >= 0) {
                            ...
                            Toast.makeText(EventActivity.this, "No event record.", Toast.LENGTH_LONG).show();
                        }
                    }
                }
